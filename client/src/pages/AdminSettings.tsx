...
type MenuSection = "user-management" | "student-management";

export default function AdminSettings() {
  const [, setLocation] = useLocation();
  const { toast } = useToast();
  const [selectedSection, setSelectedSection] = useState<MenuSection>("student-management");
...
Ahmed Hassan,ahmed.h@email.com,555-010-1005,Physical Therapy Assistant,Miami,inactive,Asylum Seeker,Student,01/19/2024`;
  ...
  const deleteAllStudentsMutation = useMutation({
    mutationFn: async () => {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.error || "Failed to delete all students");
      }
  ...
  const menuItems = [
    {
      id: "user-management" as MenuSection,
    ...
    {
      id: "student-management" as MenuSection,
      label: "Student Management",
      icon: Database,
      description: "Manage student database",
      onClick: () => setSelectedSection("student-management"),
    },
  ];
      ...
      <main className="w-[90%] mx-auto px-4 md:px-6 py-6 flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <nav className="space-y-1">
                  {menuItems.map((item) => {
                    ...
                    const isActive = selectedSection === item.id ||
                      (item.id === "user-management" && window.location.pathname === "/users");
          ...
          <div className="md:col-span-3">
            {selectedSection === "student-management" && (
              <div className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle>Student Database Management</CardTitle>
                    <CardDescription>
                      Manage the student database and perform bulk operations
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="border border-destructive/50 rounded-lg p-4 bg-destructive/5">
                            <div className="flex items-center justify-between">
                              <div>
                                <h4 className="font-medium mb-1">Delete All Students</h4>
                                <p className="text-sm text-muted-foreground">
                                  Permanently delete all student records from the database. This action cannot be undone.
                                </p>
                              </div>
                              <Button
                                variant="destructive"
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              ...
              <p>
                This action cannot be undone. All student data, including their notes and history, will be lost forever.
              </p>
          ...
          <AlertDialogFooter>
            ...
            >
              {deleteAllStudentsMutation.isPending ? "Deleting..." : "Yes, Delete All Students"}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
